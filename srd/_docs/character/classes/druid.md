...
| ------ | ------------- | --------------- | --- | --- | --- | --- | --- | --- | --- | --- |-----|-------------------------|
| 1-й | +2  | 2  | 2  | - | - | - | - | - | - | - | -  | [Мова друїдів](#мова-друїдів), [Чарування](#чарування)    |
| 2-й | +2  | 2  | 3  | - | - | - | - | - | - | - | -  | [Дика подоба](#дика-подоба), [Коло друїдів](#коло-друїдів)        |
| 3-й | +2  | 2  | 4  | 2 | - | - | - | - | - | - | -  | -                                                                 |
| 4-й | +2  | 3  | 4  | 3 | - | - | - | - | - | - | -  | [Покращення дикої подоби](#дика-подоба), Покращення здібностей |
| 5-й | +3  | 3  | 4  | 3 | 2 | - | - | - | - | - | -  | -                                                                 |
| 6-й | +3  | 3  | 4  | 3 | 3 | - | - | - | - | - | -  | Особливість кола друїдів                                          |
| 7-й | +3  | 3  | 4  | 3 | 3 | 1 | - | - | - | - | -  | -                                                                 |
| 8-й | +3  | 3  | 4  | 3 | 3 | 2 | - | - | - | - | -  | [Покращення дикої подоби](#дика-подоба), Покращення здібностей |
| 9-й | +4  | 3  | 4  | 3 | 3 | 3 | 1 | - | - | - | -  | -                                                                 |
...
| 18-й| +6  | 4  | 4  | 3 | 3 | 3 | 3 | 1 | 1 | 1 | 1  | [Вічне тіло](#вічне-тіло), [Чари звіра](#чари-звіра)          |
...
**Зброя:** Кийки, кинджали, дротики, сулиці, булави, бойові посохи, скімітари, серпи, пращі, списи    
**Інструменти:** Набір травника   
**Рятівні кидки:** Інтелект, Мудрість  
**Навички:** Виберіть дві навички серед Аркана, Приборкання тварин, Здогадливість, Медицина, Природа, Увага, Релігія та Виживання
...
### Мова друїдів
Ви знаєте таємну мову друїдів. Ви можете спілкуватися нею та залишати приховані послання. Ви та всі інші, хто знає цю мову, автоматично помічаєте такі повідомлення. Інші ж можуть помітити його наявність з успішною перевіркою Мудрості (Увага) КС 15, але розшифрувати, без допомоги магії, не зможуть.

### Чарування
Черпаючи божественну суть самої природи, ви можете формувати її для створення чар на свій смак.

#### Замовляння
На першому рівні ви знаєте два замовляння зі списку друїда за власним вибором. Ви вивчаєте додаткові замовляння друїда за власним вибором на вищих рівнях, як наведено у колонці "Відомі замовляння" таблиці класу Друїд.
...
> **КС ряткидків від чарів** = 8 + бонус майстерності + ваш модифікатор Мудрості
> 
> **Модифікатор атаки чарами** = ваш бонус майстерності + ваш модифікатор Мудрості
...
### Коло друїдів
- - -
На 2-му рівні ви вирішуєте, до якого кола друїдів приєднатися, такого як Коло Землі. Ваш вибір надає вам особливості на 2-му і потім на 6-му, 10-му і 14-му рівнях.
...
### Вічне тіло
- - -
На 18-му рівні первісна магія, яку ви опанували, дозволяє вам старіти повільніше. За кожні 10 років, що минають, ваше тіло старіє лише на 1 рік.

### Чари звіра
- - -
З 18-го рівня ви можете створювати більшість своїх чарів друїда в будь-якій дикій подобі. Набувши подоби звіра, ви можете виконувати вербальні й соматичні складові своїх чарів, але не здатні забезпечити матеріальні складові.

### Архідруїд
- - -
З 20-го рівня ви можете використовувати свою дику подобу необмежену кількість разів.   
Крім того, ви можете ігнорувати вербальні й соматичні складові своїх чарів, так само як і будь-які матеріальні складові, які не мають собівартості й не витрачаються під час створення. Ви отримуєте привілеї як у своїй нормальній формі, так і у формі звіра від дикої подоби.
...
#### Додаткове замовляння
Коли ви приєднуєтеся до цього кола на 2-му рівні, ви вивчаєте додаткове замовляння друїда за власним вибором.
...
| Рівень друїда | Чари кола                    |
| ------------- | ---------------------------------- |
| 3-й           | _стримування особи, проростання шипів_ |
| 5-й           | _завірюха, уповільнення_           |
| 7-й           | _свобода рухів, крижана буря_      |
| 9-й           | _звернення до природи, конус холоду_ |
...
| 5-й           | _дихання водою, ходіння по воді_ |
| 7-й           | _контроль води, свобода рухів_  |
| 9-й           | _з'ява стихійника, стеження_    |
...
| 7-й           | _всихання, уявна земля_                  |
| 9-й           | _нашестя комах, стіна з каменю_              |
...
| 5-й           | _накликання блискавки, ріст рослин_ |
| 7-й           | _віщування, свобода рухів_               |
| 9-й           | _звернення до природи, деревний шлях_      |

#### Луки

| Рівень друїда | Чари кола                      |
| ------------- | ------------------------------------ |
| 3-й           | _невидимість, переміщення без сліду_ |
...
| Рівень друїда | Чари кола                     |
| ------------- | ----------------------------------- |
| 3-й           | _павуче лазіння, проростання шипів_   |
| 5-й           | _заряд блискавки, злиття з каменем_  |
| 7-й           | _форма каменю, кам'яна шкіра_  |
| 9-й           | _створити прохід, стіна з каменю_ |
...
| 5-й           | _ходіння по воді, смердюча хмара_ |
| 7-й           | _свобода рухів, пошук істоти_      |
| 9-й           | _нашестя комах, стеження_     |
...
#### Хранитель природи
Коли ви досягаєте 10-го рівня, вас неможливо зачарувати або налякати стихійниками або феями, і ви маєте імунітет до отрут і хвороб.
...
> Така деревина використовується і для виготовлення інших предметів, таких як зброя і щити. Тис асоціюється зі смертю та відродженням, тож руків'я для скімітарів або серпів може бути виготовлене з нього. Ясен асоціюється із життям, а дуб - із силою. Ця деревина підходить для виготовлення руків'їв чи цілої зброї, такої як кийки та бойові посохи, а також для щитів. Вільху пов'язують із повітрям, і її можуть використовувати для метальної зброї, такої як дротики чи сулиці.   
> Друїди з регіонів, де рідко зустрічаються перелічені рослини, використовують місцеву рослинність для задоволення тих самих потреб. Наприклад, друїди в пустелях можуть обрати деревину юки або кактусів.
> ##### Друїди і боги
> 
